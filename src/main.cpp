...
int main ()
{
   ...
   auto worldBorder = resources->get_component<WorldBorder>();
	...
	auto soundRes = resources->get_component<soundTextureResources>();

	SetMusicVolume(musicRes->backgroundMusic, volume);
	SetSoundVolume(soundRes->shootingsfx, sfx_volume);
		...
		if (!Pause){ //Główna gra
   	   ...
   	   destroyBeyondWorld();
			...
			if(CheckCollisionPointRec(mousePosition, {250, 220, 400, 30})){
				...
				if(!KeybindsBtt[0]) DrawText(GetKeyText(keyb->up), 300, 220, 25, BLACK);
				...
				DrawText(GetKeyText(keyb->up), 300, 220, 25, BLACK);
			}
			if(KeybindsBtt[0]) {
				DrawText("Press a key...", 410, 220, 25, BLACK);
			...
			if(CheckCollisionPointRec(mousePosition, {250, 260, 400, 30})){
				...
				if(!KeybindsBtt[1]) DrawText(GetKeyText(keyb->down), 300, 260, 25, BLACK);
				...
				DrawText(GetKeyText(keyb->down), 300, 260, 25, BLACK);
			}
			if(KeybindsBtt[1]) {
				DrawText("Press a key...", 410, 260, 25, BLACK);
				key_number = GetKeyPressed();
				if(key_number != 0){
			...
			if(CheckCollisionPointRec(mousePosition, {250, 300, 400, 30})){
				...
				if(!KeybindsBtt[2]) DrawText(GetKeyText(keyb->left), 300, 300, 25, BLACK);
				...
				DrawText(GetKeyText(keyb->left), 300, 300, 25, BLACK);
			}
			if(KeybindsBtt[2]) {
				DrawText("Press a key...", 410, 300, 25, BLACK);
				key_number = GetKeyPressed();
				if(key_number != 0){
			...
			if(CheckCollisionPointRec(mousePosition, {250, 340, 400, 30})){
				...
				if(!KeybindsBtt[3]) DrawText(GetKeyText(keyb->right), 300, 340, 25, BLACK);
				...
				DrawText(GetKeyText(keyb->right), 300, 340, 25, BLACK);
			}
			if(KeybindsBtt[3]) {
				DrawText("Press a key...", 410, 340, 25, BLACK);
				key_number = GetKeyPressed();
				if(key_number != 0){
			...
			if(CheckCollisionPointRec(mousePosition, {250, 380, 400, 30})){
				...
				if(!KeybindsBtt[4]) DrawText(GetKeyText(keyb->shoot), 300, 380, 25, BLACK);
				...
				DrawText(GetKeyText(keyb->shoot), 300, 380, 25, BLACK);
			}
			if(KeybindsBtt[4]) {
				DrawText("Press a key...", 410, 380, 25, BLACK);
				key_number = GetKeyPressed();
				if(key_number != 0){
			...
			DrawText("Type shoot 1: ", 100, 420, 25, RED);
			if(CheckCollisionPointRec(mousePosition, {250, 420, 400, 30})){
				DrawRectangle(250, 420, 400, 30, LIGHTGRAY);
				if(!KeybindsBtt[5]) DrawText(GetKeyText(keyb->type_shoot1), 300, 420, 25, BLACK);
				...
				DrawText(GetKeyText(keyb->type_shoot1), 300, 420, 25, BLACK);
			}
			if(KeybindsBtt[5]) {
				DrawText("Press a key...", 410, 420, 25, BLACK);
				key_number = GetKeyPressed();
				if(key_number != 0){
			...
			DrawText("Type shoot 2: ", 100, 460, 25, RED);
			if(CheckCollisionPointRec(mousePosition, {250, 460, 400, 30})){
				DrawRectangle(250, 460, 400, 30, LIGHTGRAY);
				if(!KeybindsBtt[6]) DrawText(GetKeyText(keyb->type_shoot2), 300, 460, 25, BLACK);
				...
				DrawText(GetKeyText(keyb->type_shoot2), 300, 460, 25, BLACK);
			}
			if(KeybindsBtt[6]) {
				DrawText("Press a key...", 410, 460, 25, BLACK);
				key_number = GetKeyPressed();
				if(key_number != 0){
			...
			DrawText("Type shoot 3: ", 100, 500, 25, RED);
			if(CheckCollisionPointRec(mousePosition, {250, 500, 400, 30})){
				DrawRectangle(250, 500, 400, 30, LIGHTGRAY);
				if(!KeybindsBtt[7]) DrawText(GetKeyText(keyb->type_shoot3), 300, 500, 25, BLACK);
				...
				DrawText(GetKeyText(keyb->type_shoot3), 300, 500, 25, BLACK);
			}
			if(KeybindsBtt[7]) {
				DrawText("Press a key...", 410, 500, 25, BLACK);
				key_number = GetKeyPressed();
				if(key_number != 0){
			...
			if(CheckCollisionPointRec(mousePosition, {(float)x_text_position, 700, 100, 30})){
				...
				if(IsMouseButtonReleased(MOUSE_BUTTON_LEFT)){
					 Sett = false; // Exit the settings menu
				}
		  } else {
			...
			if(Datalog){
				...
				DrawText("y:", 175,700,15,BLACK);	
				DrawText(std::to_string(mousePosition.y).c_str(), 205,700,15,BLACK);
				DrawRectangle(395, 190, 200, 45, BLUE); //RESUME
				DrawRectangle(395, 400, 200, 45, GRAY); //EXIT
				DrawRectangle(395, 240, 200, 45, GREEN); //SETTINGS
			}
